...
function update() {
    ...
    if (gameOver) {
        ...
        createText(`Hai perso`, board.width / 2, board.height / 2 - 25, 'center', 50);

        createText(`punti: ${score}`, board.width / 2, board.height / 2 + 25, 'center');

        createText(`clicca col mouse per iniziare`, (cols * blockSize) / 2, board.height - 50, 'center');

        return
    }

    // Write score
    createText(`punti: ${score}`, 30, 40);
